...
// fasttrackPa = patients seen solo, fasttrackPaWithAttending = patients
// co-managed alongside an attending. Their combined rate is the sum of
// both, overriding the general `pa` rate on FastTrack only.
export const DEFAULT_PPH = {
  main: 2.1,  mainOwn: 1.3,
  fasttrack: 3.5, fasttrackOwn: 2.2,
  eru: 0.8,   eruOwn: 0.6,
  pa: 1.2, fasttrackPa: 1.2, fasttrackPaWithAttending: 0,
